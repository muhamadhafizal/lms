<!-- Resend Staff Modal -->
<div class="modal fade modal-movement" id="resend-employee-modal-{{ $key }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('superadmin.employee.resend', $employee) }}" method="post">
                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control input-group" name="user_email"
                                            value="{{ old('user_email', $employee->user_email) }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
