...
@section('content')
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <h5 class="title">Edit Company Details</h5>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('client_id') is-invalid @enderror select-tagging" name="client_id">
                                ...
                                <option value="{{ $client->id }}" 
                                    {{ old('client_id', $company->client_id ?? '') == $client->id ? 'selected' : '' }}>
                                    {{ $client->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="former_name" type="text"
                                ...
                                value="{{ old('former_name', $company->former_name) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="roc_one" type="text"
                                ...
                                value="{{ old('roc_one', $company->roc_one) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="roc_two" type="text"
                                ...
                                value="{{ old('roc_two', $company->roc_two) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="registration_date" type="date"
                                ...
                                value="{{ old('registration_date', $company->registration_date) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="invoice_date" type="date"
                                ...
                                value="{{ old('invoice_date', $company->invoice_date) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="next_renewal_date" type="date"
                                ...
                                value="{{ old('next_renewal_date', $company->next_renewal_date) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="address_one" type="text"
                                ...
                                value="{{ old('address_one', $company->address_one) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="address_two" type="text"
                                ...
                                value="{{ old('address_two', $company->address_two) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="address_three" type="text"
                                ...
                                value="{{ old('address_three', $company->address_three) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="postal" type="text"
                                ...
                                value="{{ old('postal', $company->postal) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="person_nric" type="text"
                                ...
                                value="{{ old('person_nric', $company->person_nric) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="person_designation" type="text"
                                ...
                                value="{{ old('person_designation', $company->person_designation) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="person_email" type="email"
                                ...
                                value="{{ old('person_email', $company->person_email) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="person_contact" type="text"
                                ...
                                value="{{ old('person_contact', $company->person_contact) }}">
