...
@section('content')
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <h5 class="title">New Employee Feedback Setup</h5>
            <li class="breadcrumb-item"><a href="{{ route( auth()->user()->getRoles()[0]. '.setups.employee-feedback.index') }}">Batch Setups</a></li>
            <li class="breadcrumb-item active" aria-current="page">New Employee Feedback Setup</li>
        </ol>
    </nav>
    <div class="card card-dashboard">
        <div class="card-body">
            <form method="post" action="{{ route(auth()->user()->getRoles()[0].'.setups.employee-feedback.store') }}">
                @csrf
                <div class="row">
