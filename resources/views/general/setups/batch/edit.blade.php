...
@section('content')
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <h5 class="title">Edit Batch Setup</h5>
            <li class="breadcrumb-item"><a href="{{ route( auth()->user()->getRoles()[0]. '.setups.batch.index') }}">Batch Setups</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Batch Setup</li>
        </ol>
    </nav>
    <div class="card card-dashboard">
        <div class="card-body">
            <form method="post" action="{{ route(auth()->user()->getRoles()[0].'.setups.batch.update' , $batch->id) }}">
                @csrf
                <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('company') is-invalid @enderror" name="company">
                                ...
                                @foreach ( auth()->user()->companies as $company)
                                    <option value="{{$company->id}}"
                                        {{ old('company', $batch->company->id) == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                @endforeach
                            </select>
                            @error('company')
                                <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="code" type="text"
                                ...
                                title="Please enter a valid year (YYYY) or year/month (YYYY/MM)">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="description" type="text"
                                ...
                                value="{{ old('description', $batch->description) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="active" class="form-select">
                                ...
                                <option value="0"
                                    {{ old('active', $batch->active) == '0' ? 'selected' : '' }}>
                                        Inactive</option>
                            </select>
